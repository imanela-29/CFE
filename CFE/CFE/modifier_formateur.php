...
<head>
  ...
  <title>
    <?php
      $qu = "SELECT * FROM formateur WHERE id = $dd";
                ...
                <?php
                      ...
                      if($resChe > 0){
                        while($row = mysqli_fetch_assoc($res)){
                          ...
                          <div class="row">
                            <div class="form-group col-lg-6">
                              <label for="exampleFormControlInput5">Compte Bancaire</label>
                              <input type="text" class="form-control" id="exampleFormControlInput5" value="'.$row["CB"].'" name="cb">
                            </div>
                            <div class="form-group col-lg-6">
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                              ...
                              <input type="text" class="form-control" id="exampleFormControlInput6" value="'.$row["adresse"].'" name="adresse">
                            </div>
                          </div>
                          <div class="row">
                            <div class="form-group col-lg-6">
                          ...
                          <div class="row">
                            <div class="form-group col-xl-6">
                              <label for="exampleFormControlInput70">Prix</label>
                              <input type="number" class="form-control" id="exampleFormControlInput70" value="'.$row["prix"].'" name="prix">
                            </div>
                          </div>                         
                          ';
                        }
                    ...
                    ?> 
                    <input class="btn btn-block btn-success" type="submit" name="submit" value="Enregister">
              </div>
            </form>
          </div>
        </div>
...
<?php
  ...
  if( isset($_POST["submit"]) ){
    ...
    $a = "UPDATE formateur SET nom = '$nom', email = '$email', mdp = '$mdp', CB = '$cb', cin = '$cin', adresse = '$adresse', tel = '$tel', situation = '$situation', prix = '$prix' WHERE id = '$dd' ";
    $conn->query($a);
    
    ?>
    <script type="text/javascript">
      window.location = "formateur.php";
    </script> 
    <?php
  }
