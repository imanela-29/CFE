                ...
                <div class="col">
                  ...
                  <?php
                    ...
                    if($resChe > 0){
                      while($row = mysqli_fetch_assoc($res)){
                        echo '
                          <label>Modifer la photo de profil : <span class="h3">'.$row["nom"].'</span><label>
                        ';
                  echo'
                </div>
              </div>
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                      <input class="btn btn-block btn-success" type="submit" name="ajout" value="Enregistrer">
                    </div>
                  </div>
                </div>
              </form>';
...
<?php
  ...
  if( isset($_POST["ajout"]) ){
    ...
    if($resChe > 0){
      while($row = mysqli_fetch_assoc($res)){
        // Get text
        $image_text = mysqli_real_escape_string($conn, $row["nom"]);
      }
    }    
    ...
    $q = "UPDATE formateur SET img = '$image' WHERE id = '$dd' ";
    $conn->query($q);
