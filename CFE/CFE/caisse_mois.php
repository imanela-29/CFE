        ...
        <!--<div class="col-xl-3">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe CA <br><span style="font-size: 10px;">Mois actuel</span></h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_chiffre_affaire_m.php" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe<br>caisse <br><span style="font-size: 10px;">Mois actuel</span></h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_caisse_m.php" class="btn btn-success btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe<br>charge <br><span style="font-size: 10px;">Mois actuel</span></h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_charge_m.php" class="btn btn-warning btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe bénefice <br><span style="font-size: 10px;">Mois actuel</span></h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_benefices_m.php" class="btn btn-danger btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
