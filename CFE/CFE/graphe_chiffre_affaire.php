        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">CA selon la date <span style="font-size: 10px">max 6 dates</span></h3>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody id="refresh1">
                  <?php
                    $qu = "SELECT id, date_inscription, SUM(prix_formation) as total FROM users WHERE situation = 'Réglé' GROUP BY date_inscription ORDER BY date_inscription DESC LIMIT 6";
                    $res = mysqli_query($conn,$qu);
                    $resChe = mysqli_num_rows($res);
                    if($resChe > 0){
                      while($row = mysqli_fetch_assoc($res)){
