...
session_start();
  ...
  $stmt = "SELECT dated, SUM(prix) as total FROM benefice WHERE ( dated >= DATE_FORMAT(NOW() ,'%Y-%m-01') ) GROUP BY dated";
  ...
  <script type="text/javascript">
    ...
    var config2 = {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Graphe Bénefice durant le mois actuel'
        },
        tooltips: {
          mode: 'index',
          intersect: false,
