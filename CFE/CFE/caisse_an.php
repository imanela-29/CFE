            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="graphe_chiffre_affaire_a.php" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-3">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe caisse</h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_caisse_a.php" class="btn btn-success btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-3">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe charge</h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_charge_a.php" class="btn btn-warning btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-3">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Graphe bénefice</h3>
                </div>
                <div class="col text-right">
                  <a href="graphe_benefices_a.php" class="btn btn-danger btn-sm" role="button" aria-pressed="true">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
