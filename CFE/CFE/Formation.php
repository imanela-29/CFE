      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="formation.php">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="form-group col-lg-12">
                              <label for="exampleFormControlInput1">Formation</label>
                              <input type="text" class="form-control" id="nom_formation" name="nom">
                            </div>
                          </div>
                        </div>
...
$(document).ready(
    function(){
      setInterval(function(){
        $("#refresh").load("refresh_formation.php");
      },500);
    });
...
<?php
  ...
  if( isset($_POST["submit"]) ){
    $a = $_POST["nom"];
    //$q = "INSERT INTO formation values (NULL, '$a')";
    $q = "ALTER TABLE formation ADD `$a` text not null default 'off'";
    $conn->query($q);
  }
