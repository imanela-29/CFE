            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="apprenti.php" class="btn btn-sm btn-success">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Apprentis archivées</h3>
                </div>
                <div class="col text-right">
                  <a href="apprenti_archivés.php" class="btn btn-sm btn-default">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="abs_apprenti.php" class="btn btn-sm btn-warning">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
