...
<head>
  ...
  <title>Emploi du temps | CFE</title>
  <!-- Favicon -->
          ...
          <form method="POST">
            <div class="card">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col">
                    <h3 class="mb-0">Emploi du temps<span class="text-danger" style="font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* : XX h 30 min</span></h3>
                  </div>
                  <div class="col text-right">
                    <input class="btn btn-sm btn-success" type="submit" name="submit" value="Enregister l'emploi">
                  </div>
                </div>
              </div>
              <div class="table-responsive">
                <!-- Projects table -->
                <table class="table align-items-center table-flush table-xl" style="overflow-x:auto;">
                  <thead class="thead-light">
                    <tr class="text-center">
                      <th scope="col">Jour</th>
                      <th scope="col">8h - 10h</th>
                      <th scope="col">10h - 12h</th>
                      <th scope="col">12h - 14h</th>
                      <th scope="col">14h - 16h</th>
                      <th scope="col">16h - 18h</th>
                      <th scope="col">18h - 20h</th>
                    </tr>
                  </thead>
                  <tbody>

                    <?php
                      $qu = "SELECT * FROM emploi WHERE id = '$dd'";
                      $res = mysqli_query($conn,$qu);
                      $resChe = mysqli_num_rows($res);
                      if($resChe > 0){
                        while($row = mysqli_fetch_assoc($res)){
                          ...
                          <tr class="text-center">
                            ...
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput1" value="'.$row["s1"].'" name="s1"></td>
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput2" value="'.$row["s2"].'" name="s2"></td>
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput3" value="'.$row["s3"].'" name="s3"></td>
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput4" value="'.$row["s4"].'" name="s4"></td>
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput5" value="'.$row["s5"].'" name="s5"></td>
                            <td><input style="width:140px;" type="text" class="form-control" id="exampleFormControlInput6" value="'.$row["s6"].'" name="s6"></td>
                          </tr>
                          ';
                        }
                      }
...
<?php
  ...
  if( isset($_POST["submit"]) ){
    ...
    $q = "UPDATE emploi SET s1 = '$s1', s2 = '$s2', s3 = '$s3', s4 = '$s4', s5 = '$s5', s6 = '$s6' WHERE id = '$dd'  ";
    $conn->query($q);
